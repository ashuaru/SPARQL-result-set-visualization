...
function drawBubbleMenu(root) {
    var w = window.innerWidth * 0.68 * 0.95;
    var h = Math.ceil(w * 0.7);
    var oR = 0;
    var nTop = 0;

    var svgContainer = d4.select("#chart_area")
        .style("height", h + "px");
    ...
    var colVals = d4.scale.category10();
    ...
    for (var iB = 0; iB < nTop; iB++) {
        ...
        childBubbles.append("circle")
            ...
            .on("mouseover", function (d, i) {
                ...
                d4.select("#bubbleItemNote").text(noteText);
            })
            .append("svg:title")
    ...
    resetBubbles = function () {
        ...
        d4.select("#bubbleItemNote").text("d4.js bubble menu developed by Shipeng Sun (sunsp.gis@gmail.com), Institute of Environment, University of Minnesota, and University of Springfield, Illinois.");
    ...
    function activateBubble(d, i) {
        ...
        var t = svg.transition()
            .duration(d4.event.altKey ? 7500 : 350);
