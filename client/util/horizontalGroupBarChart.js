...
function createhorizontalGroupBarChartLegend(mainDiv, columnsInfo, colorRange) {
    ...
    keys.forEach(function (d) {
        ...
        $("#Legend_" + mainDivName).append("<span class='team-graph team1' style='display: inline-block; margin-right:10px;'>\
  			...
  			<span style='padding-top: 0;font-family:Source Sans Pro, sans-serif;font-size: 13px;display: inline;' transform=''>" + columnsInfo[d] + " </span>\
  		</span>");
    });
...
function drawHorizontalGroupBarChartChart(config) {
    ...
    d3.select(mainDiv).append("svg").attr("width", 800).attr("height", 800 * 0.80).attr("class","horizontalGroupBarChart");
